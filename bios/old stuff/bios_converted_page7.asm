...
;             Done the lower half, do the upper half.
;             Hack the emulator to prompt when page 0 is being read or written (testing)
;
; *******************************************************************************************************************************
; *******************************************************************************************************************************
;
...
;
;       In the exit routine there is a point where P1 is switched from the 
;
